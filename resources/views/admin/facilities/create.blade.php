            ...
            <form action="{{ route('admin.facilities.store') }}" class="tf-section-2 form-add-rental" method="POST"
                ...
                <div class="wg-box">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="form-control" type="text" value="{{ old('name') }}" placeholder="Facility name ..." name="name" tabindex="0" required>
                    </fieldset>
                    @error('name')
                    ...
                    <div class="gap22 cols">
                        <fieldset class="sex">
                            <div class="body-title mb-10">Rental Type<span class="tf-color-1">*</span></div>
                            <div class="select">
                                <select class="" name="type" required>
                                    ...
                                    <option value="rooms" {{ old('type') === 'rooms' ? 'selected' : '' }}>Room</option>
                                </select>
                            </div>
                        </fieldset>
                    </div>
